...
@Serializable data class CreateActivityRequest(val type: String, val payload: Map<String, String> = emptyMap())
...
@Serializable data class SocketMessage(val type: String = "chat", val body: String = "", val positionMs: Long? = null, val state: String? = null)
@Serializable data class SocketEvent(val type: String, val senderUid: String? = null, val body: String? = null, val positionMs: Long? = null, val state: String? = null)
