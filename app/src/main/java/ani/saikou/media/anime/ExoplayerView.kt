...
import ani.saikou.connections.discord.RPCManager
...
import ani.saikou.hideSystemBarsExtendView
import ani.saikou.isOnline
import ani.saikou.media.EpisodeMapper
import ani.saikou.media.Media
import ani.saikou.media.MediaDetailsViewModel
import ani.saikou.media.MediaNameAdapter
import ani.saikou.media.anime.player.CastScreenView
import ani.saikou.media.anime.player.DantotsuPlayerManager
import ani.saikou.media.anime.player.PlayerAniSkipManager
import ani.saikou.media.anime.player.PlayerCastManager
import ani.saikou.media.anime.player.PlayerDiscordManager
import ani.saikou.media.anime.player.PlayerGestureManager
import ani.saikou.media.anime.player.PlayerProgressManager
import ani.saikou.media.anime.player.PlayerScreenshotManager
import ani.saikou.media.anime.player.PlayerSubtitleManager
...
import ani.saikou.util.customAlertDialog
...
class ExoplayerView : AppCompatActivity(), Player.Listener {
    ...
    companion object {
        ...
        const val ACTION_PIP_PREV_EP = "ani.saikou.PIP_PREV_EP"
        const val ACTION_PIP_REWIND = "ani.saikou.PIP_REWIND"
        const val ACTION_PIP_PLAY_PAUSE = "ani.saikou.PIP_PLAY_PAUSE"
        const val ACTION_PIP_SKIP = "ani.saikou.PIP_SKIP"
        const val ACTION_PIP_NEXT_EP = "ani.saikou.PIP_NEXT_EP"
    }
    ...
    override fun onDestroy() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            try {
                val torrentManager = uy.kohesive.injekt.Injekt.get<ani.saikou.torrent.TorrentServerManager>()
            ...
            try {
                ani.saikou.addons.torrent.TorrentServerService.stop()
            } catch (_: Exception) {}
        }
        aniSkipManager.stopTracking()
        progressManager.stopTracking()
